...
Of the **2,049 pools measured in both directions**, **5** are flat one way and confiscatory the other: under **1.0 bps** going in, at least **1000 bps** coming back.
They sit on **5 hook addresses** — but only **2 distinct contracts**: one of them is deployed more than once, and counting the deployments would count the same fact twice.
...
- `a0a9a3c0a9672c56…` — **4 hook addresses**: `0x13b399b5c738…`, `0x376b786aa1c1…`, `0xa4b8ceab9b86…`, `0xd7b5de859876…`
...
**None of these 5 hooks appears in the official registry** (978 entries, `docs/hooklist-live-20260905.json`).
