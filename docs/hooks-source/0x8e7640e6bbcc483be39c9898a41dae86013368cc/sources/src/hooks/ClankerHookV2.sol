...
abstract contract ClankerHookV2 is BaseHook, IClankerHookV2 {
    ...
    uint256 public constant PROTOCOL_FEE_NUMERATOR = 50_000; // 5% of the imposed LP fee
    ...
    uint256 public constant MAX_MEV_MODULE_DELAY = 30 days;
    ...
    // virtual hook for inheriting hooks to set fees in _beforeSwap. Must be overridden.
    ...
    // virtual hook for inheriting hooks to process data during initialization. Must be overridden.
